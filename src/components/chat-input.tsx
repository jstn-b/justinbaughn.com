    ...
    >
      <div className="relative min-w-0 overflow-hidden rounded-full">
        <input
          ...
          autoFocus={autoFocus}
          className="w-full min-w-0 max-w-full rounded-full border border-foreground/15 focus:border-foreground/25 bg-black px-5 py-3 pr-12 text-base sm:text-sm text-foreground placeholder:text-foreground/40 outline-none transition-colors"
        />
        <button
          type="submit"
          disabled={!canSend}
